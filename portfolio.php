    ...
    <ul class="block-grid-xs-1 block-grid-sm-2 portfolio-list" style="display:flex;">
      <li class="block-grid-item">
        <div class="content-work contentContainer">
          ...
          <div class="work-center">
            <a class="btn bt-enviar-contato center-block" href="assets/images/portfolio/card-karenteixeira.jpg" data-lightbox="image-1" data-title="Cartão de visita">Go</a>
          </div>
        </div>
      </li>
      <li class="block-grid-item">
        <div class="content-work contentContainer">
          ...
          <div class="work-center">
            <a class="btn bt-enviar-contato center-block"href="assets/images/portfolio/card-joaopaulo.jpg" data-lightbox="image-2" data-title="Cartão de visita">Go</a>
          </div>
        </div>
      </li>
    </ul>
